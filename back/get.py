...
if __name__ == "__main__":
    ...
    # print('-'*50)
    send_get("http://localhost:8080/history/test_0001")
    # print('-'*50)
    # send_get("http://localhost:8080/new/test")
    # print('-'*50)
    # send_get("http://localhost:8080/keywords/test_0001/我想要买点手上戴的饰品")
    # print('-'*50)
    # send_get("http://localhost:8080/result/test_0001/我想要买点手上戴的饰品/手链_手镯_手表_手环_戒指")
